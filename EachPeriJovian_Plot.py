...
for year in year_doy_pj.keys():
    for doy in year_doy_pj[year]:
        ...
        Juno_Mag_Data_Make.MinLat(Juno_MAG_FP,pj=pj)
        ...
        Juno_Mag_Data_Make.Max_Delta_Bfield_Btotal(data,B_In,B_Ex,pj=pj,Coordinate='Sys3')
        Juno_Mag_Data_Make.Max_Delta_Bfield_Btotal(data,B_In,B_Ex,pj=pj,Coordinate='Spherical')
...
for year in year_doy_pj.keys():
    for doy in year_doy_pj[year]:
        ...
        os.makedirs(filename, exist_ok=True)
        filename = f'{path}Result_pic/Juno_Orbit_{pj:0>2d}/Sys3'
        os.makedirs(filename, exist_ok=True)
        filename = f'{path}Result_pic/Juno_Orbit_{pj:0>2d}/Spherical'
        os.makedirs(filename, exist_ok=True)
        filename = f'{path}Result_pic/Juno_Orbit_{pj:0>2d}/Juno_FP'
        os.makedirs(filename, exist_ok=True)
