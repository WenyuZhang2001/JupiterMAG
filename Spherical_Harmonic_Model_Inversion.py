...
Spherical_Harmonic_InversionModel_Functions.Model_Simulation(data,B_In_obs,path=path,NMAX=25,NMIN=1,SVD_On=True,SVD_rcond=1e-15,LSTSQ_On=False,Ridge_On=False)
